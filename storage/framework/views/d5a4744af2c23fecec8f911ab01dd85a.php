...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
        ...
        <div>
            ...
            <p style="color: #64748b; font-size: 0.95rem;">Modify pricing tier parameters, duration, and active modules for plan <strong><?php echo e($plan->name); ?></strong></p>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('admin.subscriptions.plans.update', $plan->id)); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. Business Pro, Starter Pack" value="<?php echo e(old('name', $plan->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="0.00" step="0.01" value="<?php echo e(old('price', $plan->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. 30, 365" value="<?php echo e(old('duration_days', $plan->duration_days)); ?>" min="1" required>
                            ...
                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    if (is_array(old('features'))) {
                                        $isChecked = isset(old('features')[$module]);
                                    } else {
                                        $isChecked = $plan->hasModule($module);
                                    }
                                ?>
                                <div class="col-md-6">
                                    <div class="p-3 rounded-3 border d-flex gap-3 align-items-start" style="background: #fbfbfc; border-color: #e2e8f0 !important;">
                                        <input class="form-check-input mt-1" type="checkbox" name="features[<?php echo e($module); ?>]" id="feat-<?php echo e($module); ?>" value="1" <?php echo e($isChecked ? 'checked' : ''); ?>>
                                        <div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Describe this plan... (benefits, target businesses)"><?php echo e(old('description', $plan->description)); ?></textarea>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="border: 1px solid #d8e4ee !important;">
                    ...
                    <div class="card-body p-4">
                        <div>
                            ...
                            <textarea name="meta" rows="3" class="form-control rounded-3 font-monospace" placeholder='{"badge_label": "Popular", "button_text": "Choose Basic"}'><?php echo e(old('meta', $plan->meta ? json_encode($plan->meta) : '')); ?></textarea>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <select name="status" class="form-select rounded-3">
                                <option value="active" <?php echo e(old('status', $plan->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                                <option value="inactive" <?php echo e(old('status', $plan->status) === 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                            </select>
                        ...
                        <?php
                            $showInOwnerPanel = true;
                            if (is_array($plan->meta) && isset($plan->meta['show_in_owner_panel'])) {
                                $showInOwnerPanel = (bool) $plan->meta['show_in_owner_panel'];
                            }
                        ?>
                        <div class="form-check d-flex gap-2">
                            <input class="form-check-input mt-1" type="checkbox" name="show_in_owner_panel" id="show_in_owner_panel" value="1" <?php echo e(old('show_in_owner_panel', $showInOwnerPanel ? '1' : '0') == '1' ? 'checked' : ''); ?>>
                            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Subscription\resources/views/admin/plans/edit.blade.php ENDPATH**/ ?>