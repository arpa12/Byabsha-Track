            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav mx-auto gap-1">
                    <li class="nav-item">
                        <a class="nav-link" href="#features">
                            <i class="bi bi-grid-3x3-gap me-1"></i><?php echo e(__('landing.nav_features')); ?>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#cta">
                            <i class="bi bi-rocket me-1"></i><?php echo e(__('landing.nav_get_started')); ?>

                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center ms-lg-2 mt-2 mt-lg-0">
                        <span class="nav-badge">
                            <i class="bi bi-lightning-fill"></i><?php echo e(__('landing.v1_live')); ?>
                ...
                <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                    <div class="lang-switcher">
                        <a href="<?php echo e(route('language.switch', 'en')); ?>" class="lang-btn <?php echo e(app()->getLocale() === 'en' ? 'lang-active' : ''); ?>">EN</a>
                        <a href="<?php echo e(route('language.switch', 'bn')); ?>" class="lang-btn <?php echo e(app()->getLocale() === 'bn' ? 'lang-active' : ''); ?>">বাংলা</a>
                    </div>

                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard.index')); ?>" class="btn-nav-cta btn">
                            <i class="bi bi-speedometer2"></i><?php echo e(__('landing.go_to_dashboard')); ?>

                        </a>
                    <?php else: ?>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" class="nav-link" style="white-space: nowrap;"><?php echo e(__('landing.sign_in')); ?></a>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" class="btn-nav-cta btn">
                            <i class="bi bi-box-arrow-in-right"></i><?php echo e(__('landing.get_started')); ?>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-7">
                    <div class="hero-kicker reveal">
                        <i class="bi bi-stars"></i><?php echo e(__('landing.smart_business')); ?>

                    </div>

                    <h1 class="hero-title display-font reveal">
                        <?php echo e(__('landing.hero_title_1')); ?>

                        <span class="hl"><?php echo e(__('landing.hero_title_hl')); ?></span>
                        <?php echo e(__('landing.hero_title_2')); ?>

                    </h1>

                    <p class="hero-sub reveal"><?php echo e(__('landing.hero_desc')); ?></p>

                    <div class="d-flex flex-wrap gap-3 reveal">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" class="btn-hero-primary">
                            <i class="bi bi-box-arrow-in-right"></i><?php echo e(__('landing.start_tracking')); ?>

                        </a>
                        <a href="#features" class="btn-hero-outline">
                            <i class="bi bi-play-circle"></i><?php echo e(__('landing.see_features')); ?>

                        </a>
                    </div>

                    <div class="hero-trust-row reveal">
                        <span class="hero-trust-pill"><i class="bi bi-shield-check"></i><?php echo e(__('landing.feat_secure')); ?></span>
                        <span class="hero-trust-pill"><i class="bi bi-graph-up-arrow"></i><?php echo e(__('landing.feat_analytics')); ?></span>
                        <span class="hero-trust-pill"><i class="bi bi-currency-dollar"></i><?php echo e(__('landing.feat_profit')); ?></span>
                    </div>
                    ...
                    <div class="metrics-band reveal">
                        ...
                        <div class="metric-item">
                            <div class="metric-value"><?php echo e(__('landing.real_time')); ?></div>
                            <div class="metric-label"><?php echo e(__('landing.real_time_label')); ?></div>
                        </div>
                        <div class="metric-item">
                            <div class="metric-value"><?php echo e(__('landing.auto')); ?></div>
                            <div class="metric-label"><?php echo e(__('landing.capital_sync')); ?></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="hero-surface">
                        ...
                        <div class="hero-stack">
                            <div class="hero-feature">
                                ...
                                <span><?php echo e(__('landing.feat_analytics')); ?></span>
                            </div>
                            <div class="hero-feature">
                                <i class="bi bi-cash-stack"></i>
                                <span><?php echo e(__('landing.feat_profit')); ?></span>
                            </div>
                            <div class="hero-feature">
                                <i class="bi bi-shield-lock"></i>
                                <span><?php echo e(__('landing.feat_secure')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="hero-insight">
                            ...
                            <div class="hero-insight-grid">
                                ...
                                <div class="hero-insight-item">
                                    <strong><?php echo e(__('landing.real_time')); ?></strong>
                                    <span><?php echo e(__('landing.real_time_label')); ?></span>
                                </div>
                                <div class="hero-insight-item">
                                    <strong><?php echo e(__('landing.auto')); ?></strong>
                                    <span><?php echo e(__('landing.capital_sync')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="features" class="section-block">
        <div class="container">
            <div class="section-heading">
                <span class="section-badge"><?php echo e(__('landing.features_badge')); ?></span>
                <h2 class="section-title display-font"><?php echo e(__('landing.features_title')); ?></h2>
                <p class="section-sub"><?php echo e(__('landing.features_sub')); ?></p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        ...
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat1_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat1_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#ecfdf5;color:#16a34a;"><i class="bi bi-cart-check-fill"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat2_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat2_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#fefce8;color:#ca8a04;"><i class="bi bi-box-seam-fill"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat3_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat3_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#f0fdfa;color:#0d9488;"><i class="bi bi-cash-coin"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat4_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat4_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#fff7ed;color:#ea580c;"><i class="bi bi-bar-chart-line-fill"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat5_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat5_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#eef2ff;color:#4f46e5;"><i class="bi bi-shop-window"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat6_title')); ?></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        ...
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat10_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat10_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#f0fdf4;color:#15803d;"><i class="bi bi-palette-fill"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat11_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat11_desc')); ?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-card">
                        <span class="feature-icon" style="background:#f0f9ff;color:#0369a1;"><i class="bi bi-bell-fill"></i></span>
                        <h3 class="h5 mb-2"><?php echo e(__('landing.feat12_title')); ?></h3>
                        <p class="mb-0 text-secondary small"><?php echo e(__('landing.feat12_desc')); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-block">
        <div class="container">
            <div class="section-heading mb-4">
                <span class="section-badge"><?php echo e(__('landing.usage_badge')); ?></span>
                <h2 class="section-title display-font"><?php echo e(__('landing.usage_title')); ?></h2>
                <p class="section-sub mb-0"><?php echo e(__('landing.usage_sub')); ?></p>
            </div>

            <div class="workflow">
                <div class="workflow-step text-center">
                    <div class="workflow-number">01</div>
                    <h3 class="h6 mb-2"><?php echo e(__('landing.flow1_title')); ?></h3>
                    <p class="mb-0 small text-secondary"><?php echo e(__('landing.flow1_desc')); ?></p>
                </div>
                <div class="workflow-step text-center">
                    <div class="workflow-number">02</div>
                    <h3 class="h6 mb-2"><?php echo e(__('landing.flow2_title')); ?></h3>
                    <p class="mb-0 small text-secondary"><?php echo e(__('landing.flow2_desc')); ?></p>
                </div>
                <div class="workflow-step text-center">
                    <div class="workflow-number">03</div>
                    <h3 class="h6 mb-2"><?php echo e(__('landing.flow3_title')); ?></h3>
                    <p class="mb-0 small text-secondary"><?php echo e(__('landing.flow3_desc')); ?></p>
                </div>
                <div class="workflow-step text-center">
                    <div class="workflow-number">04</div>
                    <h3 class="h6 mb-2"><?php echo e(__('landing.flow4_title')); ?></h3>
                    <p class="mb-0 small text-secondary"><?php echo e(__('landing.flow4_desc')); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="cta-shell text-center text-md-start">
                <div class="row g-4 align-items-center position-relative" style="z-index:1;">
                    <div class="col-md-8">
                        <h2 class="display-font text-white" style="font-size:clamp(1.6rem,3.8vw,2.6rem);margin-bottom:0.8rem;"><?php echo e(__('landing.cta_title')); ?></h2>
                        <p class="mb-0" style="color:#cae7eb;line-height:1.8;"><?php echo e(__('landing.cta_sub')); ?></p>
                    </div>
                    <div class="col-md-4 d-flex justify-content-md-end justify-content-center">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" class="btn-hero-primary" style="background:linear-gradient(140deg,#f59e0b,#d97706);box-shadow:0 15px 24px rgba(245,158,11,.3);">
                            <i class="bi bi-box-arrow-in-right"></i><?php echo e(__('landing.cta_btn')); ?>
...
<div class="modal fade modal-login" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:460px;">
        <div class="modal-content p-4">
            ...
            <div id="mLoginPanel" style="display:<?php echo e($initialAuthPanel === 'login' ? 'block' : 'none'); ?>;">
                <h2 style="font-size:1.35rem;font-weight:700;color:#fff;text-align:center;margin-bottom:.3rem;"><?php echo e(__('auth.welcome_back')); ?></h2>
                <p style="font-size:.85rem;color:#73879b;text-align:center;margin-bottom:1rem;"><?php echo e(__('auth.sign_in_sub')); ?></p>

                <?php if($errors->any() && old('_form') !== 'register' && old('_form') !== 'forgot'): ?>
                ...
                <form action="<?php echo e(route('login.submit')); ?>" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <label style="color:#94a3b8;font-size:.82rem;font-weight:500;display:block;margin-bottom:.4rem;"><?php echo e(__('auth.email_address')); ?></label>
                        <div style="position:relative;">
                            <i class="bi bi-envelope input-icon-modal"></i>
                            <input type="email" name="email" class="form-ctrl-dark <?php echo e($errors->has('email') && old('_form') !== 'register' && old('_form') !== 'forgot' ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(__('auth.enter_email')); ?>" value="<?php echo e(old('_form') !== 'register' && old('_form') !== 'forgot' ? old('email') : ''); ?>" required autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false" readonly onfocus="this.removeAttribute('readonly');" autofocus>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label style="color:#94a3b8;font-size:.82rem;font-weight:500;display:block;margin-bottom:.4rem;"><?php echo e(__('auth.password')); ?></label>
                        <div style="position:relative;">
                            <i class="bi bi-lock input-icon-modal"></i>
                            <input type="password" id="mPwd" name="password" class="form-ctrl-dark" placeholder="<?php echo e(__('auth.enter_password')); ?>" required autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <label for="mRemember" style="font-size:.82rem;color:#73879b;cursor:pointer;margin-left:.4rem;"><?php echo e(__('auth.remember_me')); ?></label>
                        <button type="button" onclick="switchToForgot()" style="margin-left:auto;font-size:.82rem;color:#91dce0;text-decoration:none;background:none;border:none;padding:0;"><?php echo e(__('auth.forgot_password_link')); ?></button>
                    </div>

                    <button type="submit" class="btn-login-modal">
                        <i class="bi bi-box-arrow-in-right"></i><?php echo e(__('auth.sign_in')); ?>
                ...
                <div class="text-center mt-3">
                    <button type="button" onclick="switchToRegister()" style="background:none;border:none;padding:0;font-size:.84rem;color:#91dce0;cursor:pointer;">
                        <i class="bi bi-person-plus"></i> <?php echo e(__('auth.create_owner_account')); ?>

                    </button>
                </div>
            </div>

            <div id="mRegisterPanel" style="display:<?php echo e($initialAuthPanel === 'register' ? 'block' : 'none'); ?>;">
                <h2 style="font-size:1.35rem;font-weight:700;color:#fff;text-align:center;margin-bottom:.3rem;"><?php echo e(__('auth.register_heading')); ?></h2>
                <p style="font-size:.85rem;color:#73879b;text-align:center;margin-bottom:1rem;"><?php echo e(__('auth.register_subtitle')); ?></p>

                <?php if(session('manager_pending')): ?>
                    <div style="background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.3);border-radius:10px;padding:.75rem 1rem;color:#fcd34d;font-size:.875rem;display:flex;align-items:flex-start;gap:.5rem;margin-bottom:1rem;">
                        ...
                        <span><?php echo e(session('manager_pending')); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <form action="<?php echo e(route('register.submit')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        <label style="color:#94a3b8;font-size:.82rem;font-weight:500;display:block;margin-bottom:.55rem;"><?php echo e(__('auth.register_as')); ?></label>
                        <div style="display:flex;gap:.55rem;">
                            <label style="flex:1;cursor:pointer;">
                                <input type="radio" name="role" value="owner" id="regRoleOwner"
                                    <?php echo e((old('_form') !== 'register' || old('role', 'owner') === 'owner') ? 'checked' : ''); ?>
                                ...
                                <div id="regRoleOwnerBox" style="border:2px solid rgba(15,118,110,.6);border-radius:10px;padding:.65rem .55rem;text-align:center;transition:all .2s ease;background:rgba(15,118,110,.15);">
                                    ...
                                    <div style="font-size:.8rem;font-weight:700;color:#e2e8f0;"><?php echo e(__('auth.role_owner')); ?></div>
                                    <div style="font-size:.7rem;color:#73879b;margin-top:.15rem;"><?php echo e(__('auth.role_owner_hint')); ?></div>
                                </div>
                            </label>
                            <label style="flex:1;cursor:pointer;">
                                <input type="radio" name="role" value="manager" id="regRoleManager"
                                    <?php echo e((old('_form') === 'register' && old('role') === 'manager') ? 'checked' : ''); ?>
                                ...
                                <div id="regRoleManagerBox" style="border:2px solid rgba(100,116,139,.35);border-radius:10px;padding:.65rem .55rem;text-align:center;transition:all .2s ease;background:rgba(100,116,139,.08);">
                                    ...
                                    <div style="font-size:.8rem;font-weight:700;color:#e2e8f0;"><?php echo e(__('auth.role_manager')); ?></div>
                                    <div style="font-size:.7rem;color:#73879b;margin-top:.15rem;"><?php echo e(__('auth.role_manager_hint')); ?></div>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label style="color:#94a3b8;font-size:.82rem;font-weight:500;display:block;margin-bottom:.4rem;"><?php echo e(__('auth.full_name')); ?></label>
                        <div style="position:relative;">
                            <i class="bi bi-person input-icon-modal"></i>
                            <input type="text" name="name" class="form-ctrl-dark <?php echo e($errors->has('name') && old('_form') === 'register' ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(__('auth.enter_name')); ?>" value="<?php echo e(old('_form') === 'register' ? old('name') : ''); ?>" required autocomplete="name">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position:relative;">
                            <i class="bi bi-envelope input-icon-modal"></i>
                            <input type="email" name="email" class="form-ctrl-dark <?php echo e($errors->has('email') && old('_form') === 'register' ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(__('auth.enter_email')); ?>" value="<?php echo e(old('_form') === 'register' ? old('email') : ''); ?>" required autocomplete="email">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position:relative;">
                            <i class="bi bi-lock input-icon-modal"></i>
                            <input type="password" id="rPwd" name="password" class="form-ctrl-dark" placeholder="<?php echo e(__('auth.enter_password')); ?>" required autocomplete="new-password">
                    ...
                    <div class="mb-3">
                        <label style="color:#94a3b8;font-size:.82rem;font-weight:500;display:block;margin-bottom:.4rem;"><?php echo e(__('auth.confirm_new_password')); ?></label>
                        <div style="position:relative;">
                            <i class="bi bi-shield-lock input-icon-modal"></i>
                            <input type="password" id="rCPwd" name="password_confirmation" class="form-ctrl-dark" placeholder="<?php echo e(__('auth.confirm_new_password')); ?>" required autocomplete="new-password">
                    ...
                    <div id="managerNote" style="display:<?php echo e((old('_form') === 'register' && old('role') === 'manager') ? 'flex' : 'none'); ?>;align-items:flex-start;gap:.5rem;background:rgba(245,158,11,.1);border:1px solid rgba(245,158,11,.28);border-radius:10px;padding:.65rem .85rem;margin-bottom:.85rem;font-size:.82rem;color:#fcd34d;">
                        <i class="bi bi-info-circle-fill" style="margin-top:.05rem;flex-shrink:0;"></i>
                        <span><?php echo e(__('auth.manager_register_note')); ?></span>
                    </div>

                    <button type="submit" class="btn-login-modal" id="registerSubmitBtn">
                        <i class="bi bi-person-plus" id="registerBtnIcon"></i>
                        <span id="registerBtnText"><?php echo e(__('auth.register_as_owner')); ?></span>
                    </button>
                </form>
                ...
                <div class="text-center mt-3">
                    <button type="button" onclick="switchToLogin()" style="background:none;border:none;padding:0;font-size:.84rem;color:#91dce0;cursor:pointer;">
                        <i class="bi bi-box-arrow-in-right"></i> <?php echo e(__('auth.already_have_account')); ?>

                    </button>
                </div>
            </div>

            <div id="mForgotPanel" style="display:<?php echo e($initialAuthPanel === 'forgot' ? 'block' : 'none'); ?>;">
                <h2 style="font-size:1.35rem;font-weight:700;color:#fff;text-align:center;margin-bottom:.3rem;"><?php echo e(__('auth.forgot_password_heading')); ?></h2>
                <p style="font-size:.85rem;color:#73879b;text-align:center;margin-bottom:1rem;"><?php echo e(__('auth.forgot_password_subtitle')); ?></p>
                ...
                <?php if($errors->any() && old('_form') === 'forgot'): ?>
                    <div style="background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.25);border-radius:10px;padding:.75rem 1rem;color:#fca5a5;font-size:.875rem;display:flex;align-items:center;gap:.5rem;margin-bottom:1rem;">
                        <i class="bi bi-exclamation-circle-fill"></i> <?php echo e($errors->first()); ?>
                ...
                <form action="<?php echo e(route('password.email')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position:relative;">
                            <i class="bi bi-envelope input-icon-modal"></i>
                            <input type="email" name="email" class="form-ctrl-dark <?php echo e($errors->has('email') && old('_form') === 'forgot' ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(__('auth.enter_email')); ?>" value="<?php echo e(old('_form') === 'forgot' ? old('email') : ''); ?>" required autocomplete="email">
                        </div>
                    </div>

                    <button type="submit" class="btn-login-modal">
                        <i class="bi bi-envelope"></i><?php echo e(__('auth.send_reset_link')); ?>
                ...
                <div class="text-center mt-3">
                    <button type="button" onclick="switchToLogin()" style="background:none;border:none;padding:0;font-size:.84rem;color:#91dce0;cursor:pointer;">
                        <i class="bi bi-box-arrow-in-right"></i> <?php echo e(__('auth.back_to_login')); ?>
...
<script>
    ...
    function updateRegisterRole() {
        ...
        if (isManager) {
            ...
            document.getElementById('registerBtnText').textContent = '<?php echo e(__('auth.register_as_manager')); ?>';
            ...
            document.getElementById('registerBtnText').textContent = '<?php echo e(__('auth.register_as_owner')); ?>';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var shouldOpenAuthModal = <?php echo json_encode($shouldOpenAuthModal ?? false, 15, 512) ?>;
        var initialAuthPanel = <?php echo json_encode($initialAuthPanel ?? 'login', 15, 512) ?>;
        var hasLoginOldInput = <?php echo json_encode($hasLoginOldInput ?? false, 15, 512) ?>;
...
<?php /**PATH E:\personal\Byabsha-Track\Modules/Landing\resources/views/index.blade.php ENDPATH**/ ?>