...
<div class="stock-shell">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3">
        <div>
            <span class="stock-kicker mb-2"><i class="bi bi-boxes"></i> <?php echo e(__('stock::stock.title')); ?></span>
            <h1 class="page-title display-font mb-1"><i class="bi bi-boxes"></i> <?php echo e(__('stock::stock.title')); ?></h1>
            <p class="page-subtitle mb-0"><?php echo e(__('stock::stock.subtitle')); ?></p>
        </div>
        <a href="<?php echo e(route('product.index')); ?>" class="btn btn-manage-products shadow-sm">
    ...
    <div class="shop-tabs-container mb-4">
        <div class="d-flex flex-wrap gap-2">
            <a href="<?php echo e(route('stock.index', array_filter(['search' => $searchTerm]))); ?>"
               class="shop-tab-btn <?php echo e(is_null($selectedShopId) ? 'active' : ''); ?>">
                <i class="bi bi-shop-window"></i>
                <span><?php echo e(__('stock::stock.all_shops')); ?></span>
            </a>
            <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('stock.index', array_filter(['shop_id' => $shop->id, 'search' => $searchTerm]))); ?>"
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md">
            <div class="kpi-card shadow-sm h-100">
                <div class="kpi-card-inner">
                    <div class="kpi-info">
                        <span class="kpi-label"><?php echo e(__('stock::stock.total_products')); ?></span>
                        <strong class="kpi-value display-font"><?php echo e($kpiTotalProducts); ?></strong>
                    </div>
        ...
        <div class="col-6 col-md">
            <div class="kpi-card shadow-sm h-100">
                <div class="kpi-card-inner">
                    <div class="kpi-info">
                        <span class="kpi-label"><?php echo e(__('stock::stock.total_units')); ?></span>
                        <strong class="kpi-value display-font"><?php echo e(number_format($kpiTotalUnits)); ?></strong>
                    </div>
                    <div class="kpi-icon-wrapper bg-teal-light">
        ...
        <div class="col-6 col-md">
            <div class="kpi-card shadow-sm h-100">
                <div class="kpi-card-inner">
                    <div class="kpi-info">
                        <span class="kpi-label"><?php echo e(__('stock::stock.stock_value')); ?></span>
                        <strong class="kpi-value display-font"><?php echo e(number_format($kpiStockValue, 2)); ?></strong>
                    </div>
                    <div class="kpi-icon-wrapper bg-teal-light">
        ...
        <div class="col-6 col-md">
            <div class="kpi-card shadow-sm h-100">
                <div class="kpi-card-inner">
                    <div class="kpi-info">
                        <span class="kpi-label"><?php echo e(__('stock::stock.low_stock')); ?></span>
                        <strong class="kpi-value display-font <?php echo e($kpiLowStock > 0 ? 'text-amber' : ''); ?>"><?php echo e($kpiLowStock); ?></strong>
                    </div>
                    <div class="kpi-icon-wrapper <?php echo e($kpiLowStock > 0 ? 'bg-amber-light' : 'bg-neutral-light'); ?>">
                        <i class="bi bi-exclamation-triangle <?php echo e($kpiLowStock > 0 ? 'text-amber' : 'text-neutral'); ?>"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md">
            <div class="kpi-card shadow-sm h-100">
                <div class="kpi-card-inner">
                    <div class="kpi-info">
                        <span class="kpi-label"><?php echo e(__('stock::stock.out_of_stock')); ?></span>
                        <strong class="kpi-value display-font <?php echo e($kpiOutOfStock > 0 ? 'text-red' : ''); ?>"><?php echo e($kpiOutOfStock); ?></strong>
                    </div>
                    <div class="kpi-icon-wrapper <?php echo e($kpiOutOfStock > 0 ? 'bg-red-light' : 'bg-neutral-light'); ?>">
                        <i class="bi bi-x-circle <?php echo e($kpiOutOfStock > 0 ? 'text-red' : 'text-neutral'); ?>"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="filter-toolbar mb-4 shadow-sm">
        <form action="<?php echo e(route('stock.index')); ?>" method="GET" class="m-0 w-100">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="flex-shrink-0 d-flex gap-2">
                    <button type="submit" class="btn btn-filter-submit">
                        <i class="bi bi-funnel"></i> <span class="d-none d-sm-inline"><?php echo e(__('stock::stock.apply_filter')); ?></span>
                    </button>
                    <?php if($searchTerm): ?>
                        <a href="<?php echo e(route('stock.index', array_filter(['shop_id' => $selectedShopId]))); ?>" class="btn btn-filter-clear">
                            Clear
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <table class="table align-middle stock-table mb-0 w-100" id="stockDataTable">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('stock::stock.created_by')); ?></th>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var table = $('#stockDataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route("stock.index")); ?>',
                data: function (d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Stock\resources/views/index.blade.php ENDPATH**/ ?>