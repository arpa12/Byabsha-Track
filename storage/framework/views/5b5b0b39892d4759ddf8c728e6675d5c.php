...
<div class="content-card">
            ...
            <table class="table table-hover align-middle mb-0" id="productDataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($product->dynamicValues->first()?->value ?? '-'); ?></td>
                        <td>
                            <span class="shop-pill"><?php echo e($product->shop->name); ?></span>
                        </td>
                        <td><?php echo e($product->category ?? '-'); ?></td>
                        <td><?php echo e($product->brand ?? '-'); ?></td>
                        <td class="text-end"><span class="price-value">৳<?php echo e(number_format($product->purchase_price, 2)); ?></span></td>
                        <td class="text-center">
                            <?php if($product->stock_quantity <= 5): ?>
                                <span class="stock-badge stock-low"><?php echo e($product->stock_quantity); ?></span>
                            <?php elseif($product->stock_quantity <= 20): ?>
                                <span class="stock-badge stock-mid"><?php echo e($product->stock_quantity); ?></span>
                            <?php else: ?>
                                <span class="stock-badge stock-high"><?php echo e($product->stock_quantity); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="<?php echo e(route('product.batches', $product->id)); ?>"
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <h3><?php echo e(__('product.no_products')); ?></h3>
            <p><?php echo e(__('product.no_products_sub')); ?></p>
            <a href="<?php echo e(route('product.create', ['shop_id' => $selectedShopId])); ?>" class="btn btn-empty-add">
                <i class="bi bi-plus-circle"></i> <?php echo e(__('product.add_product_btn')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Product\resources/views/index.blade.php ENDPATH**/ ?>