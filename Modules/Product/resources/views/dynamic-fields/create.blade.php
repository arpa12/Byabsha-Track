...
@section('title', __('product.dynamic_create_title'))
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <span class="product-kicker"><i class="bi bi-plus-circle"></i>{{ __('product.dynamic_create_title') }}</span>
        <h1 class="page-title display-font">{{ __('product.dynamic_create_title') }}</h1>
        <p class="page-subtitle">{{ __('product.dynamic_create_subtitle') }}</p>
    </div>
...
<div class="content-card p-4">
        @include('product::dynamic-fields.form', [
