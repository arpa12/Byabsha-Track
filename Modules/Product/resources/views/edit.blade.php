...
<div class="mb-4">
    <span class="form-kicker"><i class="bi bi-pencil-square"></i>{{ __('product.edit_title') }}</span>
    <h1 class="page-title display-font">{{ __('product.edit_title') }}</h1>
    <p class="page-subtitle">{{ __('product.edit_subtitle') }}</p>
</div>
            ...
            <div class="p-4">
                <form action="{{ route('product.update', $product->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="model_name" class="form-label fw-semibold">{{ __('product.model_name') }}</label>
                            <input type="text"
                                   class="form-control @error('model_name') is-invalid @enderror"
                                   id="model_name"
                                   name="model_name"
                                   value="{{ old('model_name', $product->model_name) }}"
                                   placeholder="{{ __('product.enter_model_name') }}">
                            @error('model_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="stock_quantity" class="form-label fw-semibold">
                                {{ __('product.stock') }} <span class="text-danger">*</span>
                            </label>
                            <input type="number"
                            ...
                            @error('stock_quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">{{ __('product.stock_update_hint') }}</div>
                        </div>
                    </div>

                    <div class="content-card border rounded-3 p-3 mb-3">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="has_free_service" name="has_free_service" value="1" {{ old('has_free_service', $product->has_free_service) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number"
                                       ...
                                       min="1"
                                       value="{{ old('free_service_duration_value', $product->free_service_duration_value) }}"
                                       placeholder="6">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('free_service_duration_unit') is-invalid @enderror"
                                    ...
                                    <option value="day" {{ old('free_service_duration_unit', $product->free_service_duration_unit) === 'day' ? 'selected' : '' }}>{{ __('product.duration_day') }}</option>
                                    <option value="month" {{ old('free_service_duration_unit', $product->free_service_duration_unit) === 'month' ? 'selected' : '' }}>{{ __('product.duration_month') }}</option>
                                    <option value="year" {{ old('free_service_duration_unit', $product->free_service_duration_unit) === 'year' ? 'selected' : '' }}>{{ __('product.duration_year') }}</option>
                                </select>
                            ...
                            <div class="col-md-12 mb-0">
                                ...
                                <textarea class="form-control @error('free_service_terms') is-invalid @enderror"
                                          ...
                                          rows="2"
                                          placeholder="{{ __('product.free_service_terms_placeholder') }}">{{ old('free_service_terms', $product->free_service_terms) }}</textarea>
                    ...
                    <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-submit">
                            <i class="bi bi-check-circle"></i> {{ __('product.update_btn') }}
                        </button>
                    </div>
                </form>
            </div>
