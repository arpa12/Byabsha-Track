                        ...
                        <div class="p-4 text-white" style="background: linear-gradient(135deg, #0f766e 0%, #155e75 100%);">
                            ...
                            <div class="mt-4">
                                <span class="fs-2 fw-black" style="font-family: 'Space Grotesk', sans-serif;">
                                    <?php echo e($plan->price > 0 ? '৳' . number_format($plan->price, 0) : 'Free'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Subscription\resources/views/admin/plans/index.blade.php ENDPATH**/ ?>