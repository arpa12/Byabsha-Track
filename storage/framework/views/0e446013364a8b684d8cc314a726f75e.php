...
<div class="report-shell">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 report-header">
        <div>
            <span class="report-kicker"><i class="bi bi-bar-chart-line"></i> <?php echo e(__('app.analytics')); ?></span>
            <h1 class="page-title display-font mb-1"><?php echo e(__('report.title')); ?></h1>
            <p class="page-subtitle"><?php echo e(__('report.compact_subtitle')); ?></p>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?php echo e(route('report.print.index', request()->query())); ?>" target="_blank" class="btn-secondary-custom">
    ...
    <div class="panel mb-3">
        ...
        <div class="panel-body">
            <div class="row g-3">
                <div class="col-md-4">
                    <a href="<?php echo e(route('report.sales', ['shop_id' => $filters['shop_id']])); ?>" class="quick-link">
                        <h6><i class="bi bi-receipt me-1"></i><?php echo e(__('report.sales_report')); ?></h6>
                        <p><?php echo e(__('report.sales_report_subtitle')); ?></p>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?php echo e(route('report.products', ['shop_id' => $filters['shop_id']])); ?>" class="quick-link">
                        <h6><i class="bi bi-box-seam me-1"></i><?php echo e(__('report.products_report')); ?></h6>
                        <p><?php echo e(__('report.products_report_subtitle')); ?></p>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?php echo e(route('report.shops', ['shop_id' => $filters['shop_id']])); ?>" class="quick-link">
                        <h6><i class="bi bi-shop me-1"></i><?php echo e(__('report.shops_report')); ?></h6>
                        <p><?php echo e(__('report.shops_report_subtitle')); ?></p>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?php echo e(route('report.warranties', ['shop_id' => $filters['shop_id']])); ?>" class="quick-link">
                        <h6><i class="bi bi-shield-check me-1"></i><?php echo e(__('report.warranties_report')); ?></h6>
                        <p><?php echo e(__('report.warranties_report_subtitle')); ?></p>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?php echo e(route('report.exchanges', ['shop_id' => $filters['shop_id']])); ?>" class="quick-link">
                        <h6><i class="bi bi-arrow-left-right me-1"></i><?php echo e(__('report.exchanges_report')); ?></h6>
                        <p><?php echo e(__('report.exchanges_report_subtitle')); ?></p>
                    </a>
                </div>
                <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Report\resources/views/index.blade.php ENDPATH**/ ?>