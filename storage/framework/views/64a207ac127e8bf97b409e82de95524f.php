<?php $__env->startSection('title', __('product.create_title')); ?>
...
<div class="mb-4">
    <span class="form-kicker"><i class="bi bi-plus-circle"></i><?php echo e(__('product.create_title')); ?></span>
    <h1 class="page-title display-font"><?php echo e(__('product.create_title')); ?></h1>
    <p class="page-subtitle"><?php echo e(__('product.create_subtitle')); ?></p>
</div>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($shop->id); ?>" <?php echo e(old('shop_id', $selectedShopId ?? null) == $shop->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($brand->name); ?>" <?php echo e(old('brand') == $brand->name ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="stock_quantity" class="form-label fw-semibold">
                                <?php echo e(__('product.initial_stock')); ?> <span class="text-danger">*</span>
                            </label>
                            <input type="number"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="content-card border rounded-3 p-3 mb-3">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="has_free_service" name="has_free_service" value="1" <?php echo e(old('has_free_service') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       min="1"
                                       value="<?php echo e(old('free_service_duration_value')); ?>"
                                       placeholder="6">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="day" <?php echo e(old('free_service_duration_unit') === 'day' ? 'selected' : ''); ?>><?php echo e(__('product.duration_day')); ?></option>
                                    <option value="month" <?php echo e(old('free_service_duration_unit') === 'month' ? 'selected' : ''); ?>><?php echo e(__('product.duration_month')); ?></option>
                                    <option value="year" <?php echo e(old('free_service_duration_unit') === 'year' ? 'selected' : ''); ?>><?php echo e(__('product.duration_year')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          rows="2"
                                          placeholder="<?php echo e(__('product.free_service_terms_placeholder')); ?>"><?php echo e(old('free_service_terms')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-submit">
                            <i class="bi bi-check-circle"></i> <?php echo e(__('product.create_btn')); ?>
...
<script>
    (function () {
        ...
        const labels = {
            required: <?php echo json_encode(__('validation.required', ['attribute' => '']), 512) ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Product\resources/views/create.blade.php ENDPATH**/ ?>