<?php $__env->startSection('title', __('report.shops_report')); ?>
...
<div class="report-shell">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-4 border-bottom border-slate-200 pb-5 mb-8 report-header">
        <div>
            <span class="report-kicker"><i class="bi bi-shop-window"></i> <?php echo e(__('app.analytics')); ?></span>
            <h1 class="dashboard-title display-font text-3xl font-black text-slate-900 leading-none mb-1"><?php echo e(__('report.shops_report')); ?></h1>
            <p class="dashboard-subtitle text-slate-500 text-sm mt-1.5"><?php echo e(__('report.shops_report_subtitle')); ?></p>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?php echo e(route('report.export.shops-pdf', request()->query())); ?>" class="btn-brand-custom" style="background: linear-gradient(140deg, #ef4444, #b91c1c); box-shadow: 0 14px 28px rgba(239, 68, 68, 0.28);">
    ...
    <div class="content-card mb-4">
        ...
        <div class="p-4">
            <form action="<?php echo e(route('report.shops')); ?>" method="GET">
                <div class="row g-3">
                    <div class="col-md-3">
    ...
    <div class="content-card">
        <div class="content-card-header">
            <h5 class="content-card-title">
                ...
                <?php echo e(__('report.shop_comparison')); ?>

            </h5>
        </div>
        <div class="table-responsive">
        <?php if($shopData->count() > 0): ?>
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        <th><?php echo e(__('report.shop_name')); ?></th>
                        <th class="text-center"><?php echo e(__('report.total_products')); ?></th>
                        <th class="text-end"><?php echo e(__('report.stock_value_capital')); ?></th>
                        ...
                        <th class="text-end"><?php echo e(__('report.profit_margin')); ?></th>
                        <th class="text-center"><?php echo e(__('report.action')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__currentLoopData = $shopData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><span class="badge bg-light text-dark border"><i class="bi bi-shop"></i> <?php echo e($shop->name); ?></span></td>
                        <td class="text-center fw-bold"><?php echo e($shop->total_products); ?></td>
                        <td class="text-end font-monospace"><?php echo e(number_format($shop->stock_value, 2)); ?></td>
                        <td class="text-center font-monospace"><?php echo e($shop->total_sales); ?></td>
                        <td class="text-end font-monospace fw-bold"><?php echo e(number_format($shop->total_revenue, 2)); ?></td>
                        <td class="text-end text-success font-monospace fw-bold"><?php echo e(number_format($shop->total_profit, 2)); ?></td>
                        <td class="text-end">
                            <span class="badge rounded-pill px-2.5 <?php echo e($shop->profit_margin >= 20 ? 'bg-success-subtle text-success border border-success-subtle' : ($shop->profit_margin >= 10 ? 'bg-warning-subtle text-warning border border-warning-subtle' : 'bg-danger-subtle text-danger border border-danger-subtle')); ?>">
                                <?php echo e(number_format($shop->profit_margin, 1)); ?>%
                            </span>
                        </td>
                        <td class="text-center">
                            ...
                            <button
                                ...
                                data-shop='<?php echo json_encode($shopDataSerialized, JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_HEX_TAG, 512) ?>'
                            >
                                <i class="bi bi-eye"></i>
                            </button>
                        </td>
                ...
                <tfoot class="table-light">
                    <tr class="fw-bold">
                        <td><?php echo e(__('report.grand_total')); ?></td>
                        <td class="text-center"><?php echo e($shopData->sum('total_products')); ?></td>
                        <td class="text-end font-monospace"><?php echo e(number_format($shopData->sum('stock_value'), 2)); ?></td>
                        <td class="text-center font-monospace"><?php echo e($shopData->sum('total_sales')); ?></td>
                        <td class="text-end font-monospace"><?php echo e(number_format($shopData->sum('total_revenue'), 2)); ?></td>
                        <td class="text-end text-success font-monospace"><?php echo e(number_format($shopData->sum('total_profit'), 2)); ?></td>
                        <td class="text-end">
                            <?php
                            ...
                            ?>
                            <span class="badge rounded-pill px-2.5 <?php echo e($overallMargin >= 20 ? 'bg-success-subtle text-success border border-success-subtle' : ($overallMargin >= 10 ? 'bg-warning-subtle text-warning border border-warning-subtle' : 'bg-danger-subtle text-danger border border-danger-subtle')); ?>">
                                <?php echo e(number_format($overallMargin, 1)); ?>%
                            </span>
                        </td>
        ...
        <div class="p-5 text-center text-muted">
            ...
            <p class="mb-0"><?php echo e(__('report.no_shops_found')); ?></p>
        </div>
        <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Report\resources/views/shops.blade.php ENDPATH**/ ?>