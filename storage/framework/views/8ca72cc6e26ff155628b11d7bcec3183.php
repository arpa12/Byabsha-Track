...
<body>
        ...
        <div class="header-right">
            ...
            <div class="notification-bell">
                <button class="btn" id="notificationBell" type="button">
                    ...
                    <span class="notification-badge" id="notificationBadge" style="display: <?php echo e(auth()->user()->unreadNotificationsCount() > 0 ? 'inline-block' : 'none'); ?>">
                ...
                <div class="notification-dropdown" id="notificationDropdown">
                    ...
                    <div class="notification-dropdown-footer" id="notificationListFooter" style="display: <?php echo e($recentNotifications->count() > 0 ? 'block' : 'none'); ?>">
    ...
    <aside class="sidebar" id="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('report.sales')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('report.sales') ? 'active' : ''); ?>">
                <i class="bi bi-receipt"></i>
                <span><?php echo e(__('report.sales_report')); ?></span>
            </a>
            <a href="<?php echo e(route('report.products')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('report.products') ? 'active' : ''); ?>">
                <i class="bi bi-box-seam"></i>
                <span><?php echo e(__('report.products_report')); ?></span>
            </a>
            <a href="<?php echo e(route('report.shops')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('report.shops') ? 'active' : ''); ?>">
                <i class="bi bi-shop"></i>
                <span><?php echo e(__('report.shops_report')); ?></span>
            </a>
            <a href="<?php echo e(route('report.warranties')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('report.warranties') ? 'active' : ''); ?>">
                <i class="bi bi-shield-check"></i>
                <span><?php echo e(__('report.warranties_report')); ?></span>
            </a>
            <a href="<?php echo e(route('report.exchanges')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('report.exchanges') ? 'active' : ''); ?>">
                <i class="bi bi-arrow-left-right"></i>
                <span><?php echo e(__('report.exchanges_report')); ?></span>
            </a>
            <?php else: ?>
            <a href="<?php echo e(route('subscription.plans')); ?>" class="nav-link-custom opacity-75" title="Available on paid plans. Click to upgrade." data-bs-toggle="tooltip">
                    ...
                    if (notificationList) {
                        if (data.notifications && data.notifications.length > 0) {
                            ...
                            notificationList.innerHTML = `
                                <div class="notification-empty">
                                    <i class="bi bi-bell-slash"></i>
                                    <p class="mb-0">${escapeHtml(<?php echo json_encode(__('notifications.no_notifications'), 15, 512) ?>)}</p>
                                </div>
                            `;
                            if (notificationListFooter) {
...
<?php /**PATH E:\personal\Byabsha-Track\resources\views/layouts/app.blade.php ENDPATH**/ ?>