<?php $__env->startSection('title', __('user.approve_title')); ?>
...
<div class="user-approve-shell">
    ...
    <div class="mb-4">
        <span class="form-kicker"><i class="bi bi-person-check"></i><?php echo e(__('user.approve_title')); ?></span>
        <h1 class="page-title display-font"><?php echo e(__('user.approve_title')); ?></h1>
        <p class="page-subtitle"><?php echo e(__('user.approve_subtitle')); ?></p>
    </div>
    ...
    <div class="manager-banner mb-4 d-flex align-items-center gap-3">
        ...
        <div class="flex-grow-1">
            <div class="d-flex align-items-center gap-2 mb-1">
                <strong style="color:#92400e;font-size:1rem;"><?php echo e($user->name); ?></strong>
                <span class="pending-badge"><i class="bi bi-clock"></i><?php echo e(__('user.pending_approval')); ?></span>
            </div>
            <div style="font-size:0.88rem;color:#78350f;"><?php echo e($user->email); ?></div>
        </div>
    </div>
    ...
    <div class="content-card">
        <form action="<?php echo e(route('user.approve', $user->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <p class="section-divider"><?php echo e(__('user.assign_shop')); ?></p>
            <div class="mb-3">
                <label for="shop_id" class="form-label"><?php echo e(__('user.shop')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="section-divider"><?php echo e(__('user.assign_branch')); ?></p>
            <div class="mb-4">
                <label for="branch_id" class="form-label"><?php echo e(__('user.branch')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($branch->id); ?>"
                            ...
                            <?php if($branch->shop): ?>
                                &mdash; <?php echo e($branch->shop->name); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="section-divider"><?php echo e(__('user.manager_permissions')); ?></p>
            <div class="mb-4">
                    ...
                    <?php $__currentLoopData = $moduleAccessOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="module-access-item">
                            <input class="form-check-input me-2" type="checkbox"
                                   name="module_access[]" value="<?php echo e($key); ?>"
                                   <?php echo e(in_array($key, old('module_access', []), true) ? 'checked' : ''); ?>>
                            <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('user.show', $user->id)); ?>" class="btn btn-secondary btn-cancel">
                    <?php echo e(__('app.cancel')); ?>

                </a>
                <button type="submit" class="btn btn-approve">
                    <i class="bi bi-person-check-fill"></i><?php echo e(__('user.approve_btn')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/User\resources/views/approve.blade.php ENDPATH**/ ?>