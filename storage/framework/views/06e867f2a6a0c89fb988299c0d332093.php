...
<div class="daily-shell">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-4 border-bottom border-slate-200 pb-5 mb-8 report-header">
        <div>
            <span class="report-kicker"><i class="bi bi-calendar-day"></i> <?php echo e(__('app.analytics')); ?></span>
            <?php
                $currentShop = $shops->firstWhere('id', $filters['shop_id']);
                $shopDisplay = $currentShop ? $currentShop->name : __('report.all_shops');
            ?>
            <h1 class="dashboard-title display-font text-3xl font-black text-slate-900 leading-none mb-1"><?php echo e(__('report.daily_pnl')); ?></h1>
            <p class="dashboard-subtitle text-slate-500 text-sm mt-1.5"><?php echo e(__('report.daily_pnl_subtitle')); ?> • <strong><?php echo e(__('report.shop')); ?>:</strong> <?php echo e($shopDisplay); ?></p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Report\resources/views/daily.blade.php ENDPATH**/ ?>