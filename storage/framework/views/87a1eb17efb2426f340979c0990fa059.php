...
<?php if(auth()->user()->isSuperAdmin()): ?>
    <div class="alert alert-info border-0 rounded-4 shadow-sm mb-4 d-inline-flex align-items-center gap-2">
        ...
        <div>
            Total Categories Created: <strong class="text-dark"><?php echo e($totalCategoriesCount); ?></strong> across all users.
        </div>
    </div>
<?php endif; ?>
                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <?php if(auth()->user()->isSuperAdmin()): ?>
                            <th>Created By</th>
                        <?php endif; ?>
                        <th><?php echo e(__('category::category.product_count')); ?></th>
...
<script>
    $(document).ready(function() {
        $('#categoriesTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('category.index')); ?>",
            columns: [
