<?php $__env->startSection('title', 'Subscription Payment Requests'); ?>
...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <a href="<?php echo e(route('admin.subscriptions.active')); ?>" class="btn border rounded-pill" style="border-color: rgba(15, 118, 110, 0.35); color: #0f766e; font-size: 0.86rem; font-weight: 700; padding: 0.66rem 1.22rem;">
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="background: linear-gradient(135deg, #fff 0%, #fffbfa 100%); border-left: 4px solid #f59e0b !important;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <div class="fs-2 fw-black text-warning tracking-tight"><?php echo e($counts['pending']); ?></div>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="background: linear-gradient(135deg, #fff 0%, #f7fff9 100%); border-left: 4px solid #10b981 !important;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <div class="fs-2 fw-black text-success tracking-tight"><?php echo e($counts['approved']); ?></div>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="background: linear-gradient(135deg, #fff 0%, #fff5f5 100%); border-left: 4px solid #ef4444 !important;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <div class="fs-2 fw-black text-danger tracking-tight"><?php echo e($counts['rejected']); ?></div>
                    </div>
    ...
    <form method="GET" action="<?php echo e(route('admin.subscriptions.index')); ?>" class="card border-0 shadow-sm mb-3 p-3">
        ...
        <div class="row g-2 align-items-end">
            <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" name="search" class="form-control form-control-sm border-start-0" placeholder="Search by name or email..." value="<?php echo e($search); ?>">
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <select name="shop_id" id="filter-shop-id" class="form-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($shop->id); ?>"
                            data-branches="<?php echo e($shop->branches->map(fn($b) => ['id' => $b->id, 'name' => $b->name])->toJson()); ?>"
                            <?php echo e($shopId == $shop->id ? 'selected' : ''); ?>>
            ...
            <div class="col-sm-2 d-flex gap-1">
                ...
                <a href="<?php echo e(route('admin.subscriptions.index', ['status' => $status])); ?>" class="btn btn-sm btn-outline-secondary" title="Clear Filters"><i class="bi bi-x-lg"></i></a>
            </div>
        </div>
    </form>
    ...
    <ul class="nav nav-tabs mb-3 border-bottom border-slate-200">
        <li class="nav-item">
            <a class="nav-link <?php echo e($status == 'pending' ? 'active fw-bold' : 'text-slate-500'); ?>" href="<?php echo e(route('admin.subscriptions.index', ['status' => 'pending'])); ?>">
                Pending
                <?php if($counts['pending'] > 0): ?>
                    <span class="badge bg-warning text-dark ms-1"><?php echo e($counts['pending']); ?></span>
                <?php endif; ?>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e($status == 'approved' ? 'active fw-bold' : 'text-slate-500'); ?>" href="<?php echo e(route('admin.subscriptions.index', ['status' => 'approved'])); ?>">
                Approved
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e($status == 'rejected' ? 'active fw-bold' : 'text-slate-500'); ?>" href="<?php echo e(route('admin.subscriptions.index', ['status' => 'rejected'])); ?>">
                Rejected
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-slate-500" href="<?php echo e(route('admin.subscriptions.active')); ?>">
                <i class="bi bi-check2-circle me-1"></i>Active Subscriptions
            </a>
        </li>
    </ul>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-muted small" style="padding: 1rem 1.25rem;">#<?php echo e($req->id); ?></td>
                                    <td>
                                        <div class="fw-semibold text-slate-900"><?php echo e($req->user->name); ?></div>
                                        <div class="text-muted small"><?php echo e($req->user->email); ?></div>
                                        <?php if($req->shop): ?>
                                            <div class="text-slate-500 mt-1 small" style="font-size: 0.78rem;">
                                                <i class="bi bi-shop me-1"></i><?php echo e($req->shop->name); ?>

                                                <?php if($req->branch): ?>
                                                    <span class="text-slate-300 mx-1">|</span>
                                                    <i class="bi bi-diagram-3 me-1"></i><?php echo e($req->branch->name); ?>
                                    ...
                                    <td>
                                        <div class="fw-bold text-slate-800"><?php echo e($req->plan->name); ?></div>
                                        <span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle mt-1 small" style="font-size: 0.7rem;">
                                            <?php echo e($req->duration_months); ?> <?php echo e($req->duration_months > 1 ? 'Months' : 'Month'); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="font-monospace text-slate-700 bg-slate-100 px-2 py-1 rounded small" style="font-size: 0.82rem;"><?php echo e($req->transaction_id); ?></span>
                                    </td>
                                    <td>
                                        <span class="font-monospace text-slate-700" style="font-size: 0.85rem;"><?php echo e($req->sender_bkash_number); ?></span>
                                    </td>
                                    <td>
                                        <div class="fw-bold text-emerald-700" style="font-size: 0.95rem;"><?php echo e(currency_symbol()); ?><?php echo e(number_format($req->amount)); ?></div>
                                    </td>
                                    <td class="small text-muted">
                                        <div><?php echo e($req->created_at->format('d M Y')); ?></div>
                                        <div style="font-size: 0.76rem;"><?php echo e($req->created_at->format('h:i A')); ?></div>
                                    </td>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-danger-subtle text-danger-emphasis border border-danger-subtle rounded-pill px-2.5 py-1" title="Reason: <?php echo e($req->admin_note); ?>">Rejected</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-end" style="padding: 1rem 1.25rem;">
                                        <a href="<?php echo e(route('admin.subscriptions.show', $req)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3 fw-bold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Subscription\resources/views/admin/index.blade.php ENDPATH**/ ?>