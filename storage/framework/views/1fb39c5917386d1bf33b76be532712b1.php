...
document.addEventListener('DOMContentLoaded', function() {
    ...
    productSelect.addEventListener('change', function() {
        ...
        if (selected && selected.value) {
            ...
            productInfo.innerHTML = '<?php echo e(__("restock.current_stock_label")); ?>: <strong>' + stock + '</strong> | <?php echo e(__("restock.product_purchase_price")); ?>: <strong><?php echo e(currency_symbol()); ?>' + purchasePrice.toFixed(2) + '</strong>';
    ...
    function updatePreview() {
        ...
        document.getElementById('preview-product-price').textContent = '<?php echo e(currency_symbol()); ?>' + productPrice.toFixed(2);
        document.getElementById('preview-formula').textContent = qty + ' × <?php echo e(currency_symbol()); ?>' + price.toFixed(2);
        document.getElementById('preview-total-cost').textContent = '<?php echo e(currency_symbol()); ?>' + totalCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\personal\Byabsha-Track\Modules/Restock\resources/views/create.blade.php ENDPATH**/ ?>