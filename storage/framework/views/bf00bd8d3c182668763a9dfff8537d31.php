<?php $__env->startSection('title', __('shop.create_title')); ?>
...
<div class="mb-4">
    <h1 class="page-title"><?php echo e(__('shop.create_title')); ?></h1>
    <p class="page-subtitle"><?php echo e(__('shop.create_subtitle')); ?></p>
</div>
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  name="address"
                                  rows="3"
                                  placeholder="<?php echo e(__('shop.address_placeholder')); ?>"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-shop-theme">
                            <i class="bi bi-check-circle"></i> <?php echo e(__('shop.create_btn')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Shop\resources/views/create.blade.php ENDPATH**/ ?>