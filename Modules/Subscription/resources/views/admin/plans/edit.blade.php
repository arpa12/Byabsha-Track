...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
        ...
        <div>
            ...
            <p style="color: #64748b; font-size: 0.95rem;">Modify pricing tier parameters, duration, and active modules for plan <strong>{{ $plan->name }}</strong></p>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="border: 1px solid #d8e4ee !important;">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="e.g. Business Pro, Starter Pack" value="{{ old('name', $plan->name) }}" required>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" placeholder="0.00" step="0.01" value="{{ old('price', $plan->price) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="duration_days" class="form-control rounded-3 @error('duration_days') is-invalid @enderror" placeholder="e.g. 30, 365" value="{{ old('duration_days', $plan->duration_days) }}" min="1" required>
                            ...
                            @foreach($modules as $module)
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 rounded-3 border d-flex gap-3 align-items-start" style="background: #fbfbfc; border-color: #e2e8f0 !important;">
                                        <input class="form-check-input mt-1" type="checkbox" name="features[{{ $module }}]" id="feat-{{ $module }}" value="1" {{ $isChecked ? 'checked' : '' }}>
                                        <div>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="border: 1px solid #d8e4ee !important;">
                    ...
                    <div class="card-body p-4">
                        <textarea name="description" rows="3" class="form-control rounded-3 @error('description') is-invalid @enderror" placeholder="Describe this plan... (benefits, target businesses)">{{ old('description', $plan->description) }}</textarea>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="border: 1px solid #d8e4ee !important;">
                    ...
                    <div class="card-body p-4">
                        <div>
                            ...
                            <textarea name="meta" rows="3" class="form-control rounded-3 font-monospace" placeholder='{"badge_label": "Popular", "button_text": "Choose Basic"}'>{{ old('meta', $plan->meta ? json_encode($plan->meta) : '') }}</textarea>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="border: 1px solid #d8e4ee !important;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-check d-flex gap-2">
                            <input class="form-check-input mt-1" type="checkbox" name="show_in_owner_panel" id="show_in_owner_panel" value="1" {{ old('show_in_owner_panel', $showInOwnerPanel ? '1' : '0') == '1' ? 'checked' : '' }}>
                            <div>
