        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><span class="key-chip"><?php echo e($field->field_key); ?></span></td>
                    <td><?php echo e(strtoupper($field->input_type)); ?></td>
                    <td><?php echo e($field->category?->name ?? __('product.dynamic_all_categories')); ?></td>
                    <td class="text-center">
                        <span class="badge <?php echo e($field->is_active ? 'text-bg-success' : 'text-bg-secondary'); ?>">
                            <?php echo e($field->is_active ? __('app.active') : __('app.inactive')); ?>

                        </span>
                    </td>
                    <td class="text-center">
                        <span class="badge <?php echo e($field->is_required ? 'text-bg-danger' : 'text-bg-light border'); ?>">
                            <?php echo e($field->is_required ? __('app.yes') : __('app.no')); ?>

                        </span>
                    </td>
                    <td class="text-end">
                        <div class="btn-group btn-group-sm">
                            <a href="<?php echo e(route('product.dynamic-fields.edit', $field->id)); ?>" class="btn btn-action-edit" title="<?php echo e(__('app.edit')); ?>">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form method="POST" action="<?php echo e(route('product.dynamic-fields.destroy', $field->id)); ?>" onsubmit="return confirm('<?php echo e(__('product.confirm_delete_dynamic_field')); ?>')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-action-delete" title="<?php echo e(__('app.delete')); ?>">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="7" class="text-center py-5 text-muted"><?php echo e(__('product.no_dynamic_fields')); ?></td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\self_project\byabshaTrack\Modules/Product\resources/views/dynamic-fields/index.blade.php ENDPATH**/ ?>